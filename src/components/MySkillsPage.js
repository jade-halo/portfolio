...
<ul>
    <li>
    브랜드 아이덴티티를 기반으로 브랜드 관리 및 전략 수립 역량
    </li>
    <li>
    모든 이해관계자들을 한 방향으로 이끄는 커뮤니케이션 스킬
    </li>
    <li>
    IMC 차원의 ATL&BTL 브랜드 캠페인 Plan-Do-See 진행
    </li>
    <li>
    데이터 기반의 NPD 프로세스를 통한 신제품 기획 및 개발
    </li>
    <li>
    제품 포트폴리오 관리와 문제 발생시의 이슈 해결 능력
    </li>
    <li>
    Win-Win 전략의 이종업종간 콜라보레이션 기획 및 실행
    </li>
    <li>
    ROI 분석을 통한 온오프라인 프로모션 및 디지털 마케팅 실행
    </li>
</ul>
</p>
</Description>
